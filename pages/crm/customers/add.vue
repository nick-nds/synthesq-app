    ...
    <div class="sticky top-0 z-10 backdrop-blur-xl bg-white/80 border-b border-white/20 shadow-lg shadow-neutral-900/5">
      <div class="max-w-7xl mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-bold bg-gradient-to-r from-neutral-900 to-neutral-700 bg-clip-text text-transparent">Add New Customer</h1>
            <p class="text-neutral-500 mt-1">Create a new customer profile and establish business relationships</p>
          </div>
            ...
            <div class="group relative">
              ...
              <div class="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300">
                <div class="flex items-center mb-6">
                  ...
                  <div>
                    <h3 class="text-xl font-bold text-neutral-900">Address Information</h3>
                    <p class="text-neutral-500 text-sm">Physical location and contact address</p>
                  </div>
                </div>
                <div class="grid grid-cols-1 gap-6">
                  <div class="space-y-2">
                    <label for="address" class="block text-sm font-semibold text-neutral-700">Street Address</label>
                    <input
                      id="address"
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="space-y-2">
                      <label for="city" class="block text-sm font-semibold text-neutral-700">City</label>
                      <input
                        id="city"
                        v-model="form.city"
                        type="text"
                    ...
                    <div class="space-y-2">
                      <label for="state" class="block text-sm font-semibold text-neutral-700">State/Province</label>
                      <input
                        id="state"
                        v-model="form.state"
                        type="text"
                    ...
                    <div class="space-y-2">
                      <label for="zipCode" class="block text-sm font-semibold text-neutral-700">ZIP/Postal Code</label>
                      <input
                        id="zipCode"
                  ...
                  <div class="space-y-2">
                    <label for="country" class="block text-sm font-semibold text-neutral-700">Country</label>
                    <input
                      id="country"
          ...
          <div class="sticky top-24">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/30 shadow-xl">
              ...
              <div class="space-y-3">
                ...
                <div class="flex justify-between items-center">
                  <span class="text-sm text-neutral-600">Tags Added</span>
...
// Computed properties
const totalFields = 5 // Required fields
...
const saveCustomer = async () => {
  ...
  try {
    ...
    // Success - redirect to customers with success message
    await router.push('/customers?success=Customer created successfully')
  } catch (error) {
